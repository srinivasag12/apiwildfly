 ...
 * @author rupesh
 *	
 * Encryption decryption , this encryption may contains / .
 */
...
public class EncryptionDecrytion {
	...
	private static final String secret = "rk7488%klsdfii67jGG87wjjsdl837-nsdf712lsdfjHGJTIK67ldirekdims98484jsdfkHJYH";
	...
	public static String encryptWithoutSlace(String str) {
		String encryptedText = encrypt(str);
